...
class Config(MyConfig):
    def __init__(self):
        ...
        with open('/home/ubuntu/AIDMS_Model_Damo_Yolo/customized/results/leadtek.names','r') as cls:
        ...
        structure = self.read_structure(
            '/home/ubuntu/AIDMS_Model_Damo_Yolo/customized/damo-yolo/damo/base_models/backbones/nas_backbones/tinynas_nano_large.txt')
        TinyNAS = {
            'name': 'TinyNAS_mob',
