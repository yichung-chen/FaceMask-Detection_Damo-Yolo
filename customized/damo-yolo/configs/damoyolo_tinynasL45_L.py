...
class Config(MyConfig):
    def __init__(self):
        ...
        self.train.finetune_path='/home/ubuntu/Mask-Det_Damo_Yolo/customized/models/pretrained/damoyolo_tinynasL45_L.pth'
        # backbone
        structure = self.read_structure(
            '/home/ubuntu/Mask-Det_Damo_Yolo/customized/models/damo-yolo/damo/base_models/backbones/nas_backbones/tinynas_L45_kxkx.txt')
        TinyNAS = {
            'name': 'TinyNAS_csp',
