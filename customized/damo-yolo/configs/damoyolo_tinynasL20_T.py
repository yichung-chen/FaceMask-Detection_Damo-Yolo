...
class Config(MyConfig):
    def __init__(self):
        ...
        with open('/home/ubuntu/Mask-Det_Damo_Yolo/customized/results/classes.names','r') as cls:
            ...
            #print(cls_info[0].splitlines()[0].split(':')[1])
            #print(cls_info[1].split(':')[1])
        
        print(classes_name)
        self.dataset.nc = nc

        self.train.finetune_path='/home/ubuntu/Mask-Det_Damo_Yolo/customized/models/pretrained/damoyolo_tinynasL20_T.pth'
        # backbone

        structure = self.read_structure(
            '/home/ubuntu/Mask-Det_Damo_Yolo/customized/damo-yolo/damo/base_models/backbones/nas_backbones/tinynas_L20_k1kx.txt')
        TinyNAS = {
            'name': 'TinyNAS_res',
